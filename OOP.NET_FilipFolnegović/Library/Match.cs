...
namespace Library
{
    // These enums should also be public, go figure xD.
    ...
    // Make all partial classes public!!!
    ...
    public partial class Player
    {
        ...
        public static Player Parse(string player)
        {
            ...
            return new Player()
            {
                ...
                Captain = int.Parse(properties[2]) == 500,
                Position = (Positions)Enum.Parse(typeof(Positions), properties[3]),
                Favorite = int.Parse(properties[4]) == 700,
                ImagePath = !string.IsNullOrEmpty(properties[5]) ? properties[5] : null,
                NoYellowCards = 0,
                NoGoals = 0,
            };
        }
        ...
        public override string ToString() => $"{Name} {ShirtNumber} {((bool)Captain ? "DA" : "NE")} {Position}";
    }
